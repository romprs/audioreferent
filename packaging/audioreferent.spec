...
%changelog
* Fri Sep 18 2026 romprs <romprs@gmail.com> - 0.1.0-12
- Помощник произносит напоминания о встречах по просьбе почты (напоминалка в трее): канал доступен только владельцу сеанса
* Fri Sep 18 2026 romprs <romprs@gmail.com> - 0.1.0-11
- Удаление участников в окне встречи: «удали Смирнова», «убери второго», «удали всех участников»; несколько совпадений — «Найдено 2 … назовите номер»
- «Открой календарь», «открой контакты» — окно почты на нужном разделе
- Изменение встречи: «Что поменять?» — «время начала на десять», «продолжительность на час», «добавь …», «удали …»; после правки «Что ещё поменять?»
- Перенос встречи: только день, время и длительность, затем «Что ещё поменять?»
- «Вика, отмена» при открытой встрече закрывает окно встречи, а не запускает другую команду
- Даты: «завтрашнюю», «сегодняшнее», число без месяца («на двадцатое») и дата без года — ближайшие вперёд; «в девять вечера» — 21:00
